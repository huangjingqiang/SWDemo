...
public class SmallVideoViewLiveAdapter extends VideoViewLiveAdapter {
    private final static Logger log = LoggerFactory.getLogger(SmallVideoViewLiveAdapter.class);

    public SmallVideoViewLiveAdapter(Context context, int exceptedUid, HashMap<Integer, SurfaceView> uids, VideoViewEventListener listener) {
